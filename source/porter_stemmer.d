...
{
    auto mappings = [
        tuple("ational", "ate"), tuple("tional", "tion"), tuple("enci",
        "ence"), tuple("anci", "ance"), tuple("izer", "ize"), tuple("abli",
        "able"), tuple("alli", "al"), tuple("entli", "ent"), tuple("eli", "e"),
...
unittest
{
    ...
    auto cases = [
        ...
        tuple("motoring", "motor"), tuple("sing", "sing"),//1b2
        tuple("conflated",
        "conflate"), tuple("troubled", "trouble"), tuple("sized", "size"),
        tuple("hopping", "hop"), tuple("tanned", "tan"), tuple("falling",
        "fall"), tuple("hissing", "hiss"), tuple("fizzed", "fizz"),
        tuple("failing", "fail"), tuple("filing", "file"),//1c
        tuple("happy",
        "happi"), tuple("sky", "sky"),// 2
        tuple("relational", "relate"),
        tuple("conditional", "condition"), tuple("rational", "rational"),
        tuple("valenci", "valence"), tuple("hesitanci", "hesitance"),
        ...
        tuple("vietnamization", "vietnamize"), tuple("predication",
        "predicate"), tuple("operator", "operate"), tuple("feudalism",
        "feudal"), tuple("decisiveness", "decisive"), tuple("hopefulness",
        "hopeful"), tuple("callousness", "callous"), tuple("formaliti",
        "formal"), tuple("sensitiviti", "sensitive"), tuple("sensibiliti", "sensible"),
    ];
